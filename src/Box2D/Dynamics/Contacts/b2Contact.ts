...
import { b2Shape, b2ContactRegister, b2CircleContact, b2PolyAndCircleContact, b2PolygonContact, b2ConcaveArcAndCircleContact, b2PolyAndConcaveArcContact, b2StaticEdgeAndCircleContact, b2PolyAndStaticEdgeContact, b2Manifold, b2Math, b2ContactListener, b2Body, b2ContactEdge } from "../..";
...
{
	public GetManifolds():Array<any> {return []};
	...
	constructor(s1:b2Shape=null, s2:b2Shape=null)
	{
		...
		{
			this.m_flags |= this.e_nonSolidFlag;
		}
