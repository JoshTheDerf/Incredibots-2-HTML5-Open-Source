...
export class ColourChangeWindow extends GuiWindow {
  ...
  private okButton(e: Event): void {
    this.cancelButton(e);
    this.cont.colourButton(
      parseInt(this.m_redArea.text),
      parseInt(this.m_greenArea.text),
      parseInt(this.m_blueArea.text),
      parseInt(this.m_opacityArea.text),
      this.m_defaultBox.selected
    );
  }
