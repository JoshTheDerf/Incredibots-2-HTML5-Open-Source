package Gui
{
	...
	public class PostReplayWindow extends GuiWindow
	{
		...
		public function PostReplayWindow(contr:ControllerGame)
		{
			...
			m_mainMenuButton = new GuiButton("Main Menu", 22, (ControllerGameGlobals.curReplayID == "" ? 135 : 165), 110, 35, mainMenuButton, GuiButton.PURPLE);
			addChild(m_mainMenuButton);
			m_closeButton = new GuiButton("Close", 22, (ControllerGameGlobals.curReplayID == "" ? 165 : 195), 110, 35, cancelButton, GuiButton.PURPLE);
