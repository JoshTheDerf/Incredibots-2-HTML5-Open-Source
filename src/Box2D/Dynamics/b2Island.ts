...
import { b2Body, b2Contact, b2ContactConstraint, b2ContactConstraintPoint, b2ContactListener, b2ContactResult, b2ContactSolver, b2Joint, b2Manifold, b2ManifoldPoint, b2Mat22, b2Math, b2Settings, b2TimeStep, b2Vec2 } from "..";
...
export class b2Island
{
	...
	{
		var i:number, b:b2Body, joint:b2Joint;
		...
		if (correctPositions)
		{
			...
			{
				var contactsOkay:boolean = contactSolver.SolvePositionConstraints(b2Settings.b2_contactBaumgarte), jointsOkay:boolean = true;
		...
		if (allowSleep){
			...
			var minSleepTime:number = Number.MAX_VALUE, linTolSqr:number = b2Settings.b2_linearSleepTolerance * b2Settings.b2_linearSleepTolerance, angTolSqr:number = b2Settings.b2_angularSleepTolerance * b2Settings.b2_angularSleepTolerance;
	...
	public SolveTOI(subStep:b2TimeStep) : void
	{
		...
		// Solve velocity constraints.
		var mi:number = subStep.maxIterations;
		for (i = 0; i < mi; ++i)
		{
			contactSolver.SolveVelocityConstraints();
		}
	...
	public Report(constraints:Array<any>) : void
	{
		var tMat:b2Mat22;
		var tVec:b2Vec2;
		...
		for (var i:number = 0; i < this.m_contactCount; ++i)
		{
			...
			var cr:b2ContactResult = b2Island.s_reportCR;
			...
			for (var j:number = 0; j < manifoldCount; ++j)
			{
				...
				var pc:number = manifold.pointCount;
	...
	public m_bodies:Array<any>;
	public m_contacts:Array<any>;
	public m_joints:Array<any>;
