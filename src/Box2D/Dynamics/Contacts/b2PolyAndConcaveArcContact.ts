...
import { b2PolygonContact, Features, b2Shape, b2Contact, b2Manifold, b2ContactListener, b2Body, b2Collision, b2ManifoldPoint, b2PolygonShape, b2ConcaveArcShape, b2Vec2, b2Math, b2Mat22 } from "../..";
...
export class b2PolyAndConcaveArcContact extends b2PolygonContact
{
	...
	constructor(shape1:b2Shape, shape2:b2Shape): void{
		super(shape1, shape2);
	}
	//~b2PolyContact() {}
	...
	public Evaluate(listener:b2ContactListener): void{
		...
		//Do arc vs poly collision
		{
			...
			var worlds:Array<any>= [world0,world1];
			var locals:Array<any>= [local0,local1];
			...
			var arcLimitations:Array<any>= [-1,-1];
		...
		var arcManiCount:number=this.m_manifoldCount;
		if(polySep>arcSep)
		{
