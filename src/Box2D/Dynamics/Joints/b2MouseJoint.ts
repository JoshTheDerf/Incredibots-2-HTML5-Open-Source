...
import { b2Body, b2Joint, b2Mat22, b2MouseJointDef, b2Settings, b2TimeStep, b2Vec2 } from "../..";
...
export class b2MouseJoint extends b2Joint
{
	...
	constructor(def:b2MouseJointDef){
		...
		var tX:number = this.m_target.x - this.m_body2.m_xf.position.x;
		var tY:number = this.m_target.y - this.m_body2.m_xf.position.y;
		...
		var mass:number = this.m_body2.m_mass;
