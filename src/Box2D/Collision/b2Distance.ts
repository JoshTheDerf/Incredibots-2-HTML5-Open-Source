...
import { b2Shape, b2DistanceRegister, b2Vec2, b2XForm, b2Math, b2CircleShape, b2Mat22, b2Settings, b2StaticEdgeShape, b2ManifoldPoint, b2Point, b2PolygonShape, b2ConcaveArcShape } from "..";
...
public static ProcessTwo(x1:b2Vec2, x2:b2Vec2, p1s:Array<any>, p2s:Array<any>, points:Array):number
{
...
// - inside the triangle
public static ProcessThree(x1:b2Vec2, x2:b2Vec2, p1s:Array<any>, p2s:Array<any>, points:Array):number
{
	var points_0:b2Vec2 = points[0];
	var points_1:b2Vec2 = points[1];
	...
	circle:b2CircleShape, xf2:b2XForm) :number
{
	...
	// Create variation of to replace template
