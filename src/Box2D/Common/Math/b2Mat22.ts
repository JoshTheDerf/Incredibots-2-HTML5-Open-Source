...
export class b2Mat22
{
	...
	{
		var a:number = this.col1.x, b:number = this.col2.x, c:number = this.col1.y, d:number = this.col2.y;
	...
	public Solve(out:b2Vec2, bX:number, bY:number):b2Vec2
	{
		...
		var a11:number = this.col1.x, a12:number = this.col2.x, a21:number = this.col1.y, a22:number = this.col2.y;
