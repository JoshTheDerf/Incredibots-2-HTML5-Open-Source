...
export class b2Pair
{
	...
	public static b2_tableCapacity:number = b2Settings.b2_maxPairs;	// must be a power of two
	public static b2_tableMask:number = b2Pair.b2_tableCapacity - 1;

	// enum
	public static e_pairBuffered:number = 0x0001;
	public static e_pairRemoved:number = 0x0002;
	public static e_pairFinal:number = 0x0004;
