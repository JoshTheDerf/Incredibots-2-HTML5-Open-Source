...
export class MainEditPanel extends GuiWindow
	{
		...
		constructor(contr:ControllerGame) {
			...
			if (!Main.inIFrame) {
				...
				this.m_triangleButton = new GuiButton("Triangle", 210, 15, 105, 35, () => this.cont.triangleButton(), GuiButton.BLUE);
				this.m_editPanel.addChild(this.m_triangleButton);
				this.m_fixedJointButton = new GuiButton("Fixed Joint", 10, 45, 105, 35, () => this.cont.fjButton(), GuiButton.BLUE);
				this.m_editPanel.addChild(this.m_fixedJointButton);
				this.m_revoluteJointButton = new GuiButton("Rotating Joint", 110, 45, 105, 35, () => this.cont.rjButton(), GuiButton.BLUE);
				this.m_editPanel.addChild(this.m_revoluteJointButton);
				this.m_prismaticJointButton = new GuiButton("Sliding Joint", 210, 45, 105, 35, () => this.cont.pjButton(), GuiButton.BLUE);
			...
			this.m_conditionsButton = new GuiButton("Set Conditions", 520, 45, 95, 35, () => this.cont.conditionsButton(), GuiButton.BLUE);
			this.m_buildBoxButton = new GuiButton("Build Box", 610, 45, 85, 35, () => this.cont.buildBoxButton(), GuiButton.BLUE);
			this.m_restrictionsButton = new GuiButton("Restrictions", 695, 15, 95, 30, () => this.cont.restrictionsButton(), GuiButton.BLUE);
			...
			this.m_testButton = new GuiButton("    Test\nChallenge", 700, 35, 85, 45, () => this.cont.playButton(), GuiButton.PLAY);
			...
			this.m_resetButton = new GuiButton("Stop", 700, 35, 85, 45, () => (ControllerGameGlobals.playingReplay ? this.cont.rewindButton() : this.cont.resetButton()), GuiButton.PLAY, format);
			this.m_gamePanel.addChild(this.m_resetButton);
			this.m_resetButton2 = new GuiButton("Stop", 700, 35, 85, 45, () => (ControllerGameGlobals.playingReplay ? this.cont.rewindButton() : this.cont.resetButton()), GuiButton.PLAY, format);
			this.m_pausePanel.addChild(this.m_resetButton2);
			this.m_rewindButton = new GuiButton((ControllerGameGlobals.playingReplay ? "Rewind" : "Restart"), 535, 45, 75, 35, () => (ControllerGameGlobals.playingReplay ? this.cont.resetButton() : this.cont.rewindButton()), GuiButton.RED);
			this.m_gamePanel.addChild(this.m_rewindButton);
			this.m_rewindButton2 = new GuiButton((ControllerGameGlobals.playingReplay ? "Rewind" : "Restart"), 535, 45, 75, 35, () => (ControllerGameGlobals.playingReplay ? this.cont.resetButton() : this.cont.rewindButton()), GuiButton.RED);
			this.m_pausePanel.addChild(this.m_rewindButton2);
			if (!ControllerGameGlobals.playingReplay) {
				this.m_saveReplayButton = new GuiButton("Save Replay", 550, 15, 120, 35, () => this.cont.saveReplayButton(), GuiButton.PURPLE);
				this.m_gamePanel.addChild(this.m_saveReplayButton);
				this.m_saveReplayButton2 = new GuiButton("Save Replay", 550, 15, 120, 35, () => this.cont.saveReplayButton(), GuiButton.PURPLE);
			...
			this.m_featureButton2 = new GuiButton("Feature!", 85, 15, 90, 35, this.cont.featureButton, GuiButton.PURPLE);
			this.m_featureButton2.visible = false;
			this.m_pausePanel.addChild(this.m_featureButton2);
			this.ShowFeatureButton();
			this.m_rateButton = new GuiButton((ControllerGameGlobals.playingReplay ? "Rate this Replay!" : "Rate this Robot!"), 165, 15, 140, 35, this.rateButton, GuiButton.ORANGE);
			this.m_gamePanel.addChild(this.m_rateButton);
			this.m_rateButton2 = new GuiButton((ControllerGameGlobals.playingReplay ? "Rate this Replay!" : "Rate this Robot!"), 165, 15, 140, 35, this.rateButton, GuiButton.ORANGE);
			this.m_pausePanel.addChild(this.m_rateButton2);
			this.m_rateButton3 = new GuiButton("Rate this Challenge!", 165, 15, 140, 35, this.rateButton, GuiButton.ORANGE);
			this.m_rateButton3.visible = false;
			this.m_gamePanel.addChild(this.m_rateButton3);
			this.m_rateButton4 = new GuiButton("Rate this Challenge!", 165, 15, 140, 35, this.rateButton, GuiButton.ORANGE);
			this.m_rateButton4.visible = false;
			this.m_pausePanel.addChild(this.m_rateButton4);
			this.m_commentButton = new GuiButton((ControllerGameGlobals.playingReplay ? "Comment on this Replay" : "Comment on this Robot"), 15, 45, 160, 35, this.commentButton, GuiButton.ORANGE);
			this.m_gamePanel.addChild(this.m_commentButton);
			this.m_commentButton2 = new GuiButton((ControllerGameGlobals.playingReplay ? "Comment on this Replay" : "Comment on this Robot"), 15, 45, 160, 35, this.commentButton, GuiButton.ORANGE);
			this.m_pausePanel.addChild(this.m_commentButton2);
			this.m_commentButton3 = new GuiButton("Comment on this Challenge", 15, 45, 160, 35, this.commentButton, GuiButton.ORANGE);
			this.m_commentButton3.visible = false;
			this.m_gamePanel.addChild(this.m_commentButton3);
			this.m_commentButton4 = new GuiButton("Comment on this Challenge", 15, 45, 160, 35, this.commentButton, GuiButton.ORANGE);
			this.m_commentButton4.visible = false;
			this.m_pausePanel.addChild(this.m_commentButton4);
			this.m_linkButton = new GuiButton((ControllerGameGlobals.playingReplay ? "Link to this Replay" : "Link to this Robot"), 165, 45, 140, 35, this.linkButton, GuiButton.ORANGE);
			this.m_gamePanel.addChild(this.m_linkButton);
			this.m_linkButton2 = new GuiButton((ControllerGameGlobals.playingReplay ? "Link to this Replay" : "Link to this Robot"), 165, 45, 140, 35, this.linkButton, GuiButton.ORANGE);
			this.m_pausePanel.addChild(this.m_linkButton2);
			this.m_linkButton3 = new GuiButton("Link to this Challenge", 165, 45, 140, 35, this.linkButton, GuiButton.ORANGE);
			this.m_linkButton3.visible = false;
			this.m_gamePanel.addChild(this.m_linkButton3);
			this.m_linkButton4 = new GuiButton("Link to this Challenge", 165, 45, 140, 35, this.linkButton, GuiButton.ORANGE);
			this.m_linkButton4.visible = false;
			this.m_pausePanel.addChild(this.m_linkButton4);
			this.m_embedButton = new GuiButton((ControllerGameGlobals.playingReplay ? "Embed this Replay" : "Embed this Robot"), 295, 45, 140, 35, this.embedButton, GuiButton.ORANGE);
			this.m_gamePanel.addChild(this.m_embedButton);
			this.m_embedButton2 = new GuiButton((ControllerGameGlobals.playingReplay ? "Embed this Replay" : "Embed this Robot"), 295, 45, 140, 35, this.embedButton, GuiButton.ORANGE);
			this.m_pausePanel.addChild(this.m_embedButton2);
			this.m_embedButton3 = new GuiButton("Embed this Challenge", 295, 45, 140, 35, this.embedButton, GuiButton.ORANGE);
			this.m_embedButton3.visible = false;
			this.m_gamePanel.addChild(this.m_embedButton3);
			this.m_embedButton4 = new GuiButton("Embed this Challenge", 295, 45, 140, 35, this.embedButton, GuiButton.ORANGE);
			...
			if (['ControllerTutorial', 'ControllerHomeMovies', 'ControllerRubeGoldberg', 'ControllerNewFeatures', 'ControllerChallengeEditor'].includes(controllerName)) {
				this.m_tutorialButton = new GuiButton("View Previous Tip", 660, 90, 140, 40, this.cont.tutorialButton, GuiButton.PURPLE);
			...
			this.m_timer1.width = 80;
			this.m_timer1.height = 30;
			this.m_timer1.x = 30;
			this.m_timer1.y = 22;
			...
			this.m_timer2.width = 80;
			this.m_timer2.height = 30;
			this.m_timer2.x = 30;
			this.m_timer2.y = 22;
		...
		public rateButton(e:MouseEvent):void {
			if (ControllerGameGlobals.playingReplay && ControllerGameGlobals.curReplayID != "" && ControllerGameGlobals.curReplayPublic) {
				this.cont.rateReplayButton(e);
			} else if (ControllerGameGlobals.curChallengeID != "" && ControllerGameGlobals.curChallengePublic) {
				this.cont.rateChallengeButton(e);
			} else {
				this.cont.rateButton(e);
			}
		}

		public commentButton(e:MouseEvent):void {
			if (ControllerGameGlobals.playingReplay && ControllerGameGlobals.curReplayID != "" && ControllerGameGlobals.curReplayPublic) {
				this.cont.commentReplayButton(e);
			} else if (ControllerGameGlobals.curChallengeID != "" && ControllerGameGlobals.curChallengePublic) {
				this.cont.commentChallengeButton(e);
			} else {
				this.cont.commentButton(e);
			}
		}

		public linkButton(e:MouseEvent):void {
			if (ControllerGameGlobals.playingReplay && ControllerGameGlobals.curReplayID != "" && ControllerGameGlobals.curReplayPublic) {
				this.cont.linkReplayButton(e);
			} else if (ControllerGameGlobals.curChallengeID != "" && ControllerGameGlobals.curChallengePublic) {
				this.cont.linkChallengeButton(e);
			} else {
				this.cont.linkButton(e);
			}
		}

		public embedButton(e:MouseEvent):void {
			if (ControllerGameGlobals.playingReplay && ControllerGameGlobals.curReplayID != "" && ControllerGameGlobals.curReplayPublic) {
				this.cont.embedReplayButton(e);
			} else if (ControllerGameGlobals.curChallengeID != "" && ControllerGameGlobals.curChallengePublic) {
				this.cont.embedChallengeButton(e);
			} else {
				this.cont.embedButton(e);
			}
		}
		...
		public SetTimer(frameCounter:number):void {
			if (frameCounter >= 108000) {
				...
				var mins:number = frameCounter / 1800;
				frameCounter %= 1800;
				var secs:number = frameCounter / 30;
				if (secs < 10) {
		...
		public ShowEditPanel(wasPlayingReplay:boolean = false):void {
			...
			if (wasPlayingReplay) {
				...
				this.m_pausePanel.addChild(this.m_rewindButton2);
				this.m_saveReplayButton = new GuiButton("Save Replay", 558, 15, 120, 35, this.cont.saveReplayButton, GuiButton.PURPLE);
				this.m_gamePanel.addChild(this.m_saveReplayButton);
				this.m_saveReplayButton2 = new GuiButton("Save Replay", 558, 15, 120, 35, this.cont.saveReplayButton, GuiButton.PURPLE);
				this.m_pausePanel.addChild(this.m_saveReplayButton2);

				this.m_commentButton = new GuiButton("Comment on this Robot", 15, 45, 160, 35, this.commentButton, GuiButton.ORANGE);
				this.m_gamePanel.addChild(this.m_commentButton);
				this.m_commentButton2 = new GuiButton("Comment on this Robot", 15, 45, 160, 35, this.commentButton, GuiButton.ORANGE);
				this.m_pausePanel.addChild(this.m_commentButton2);
		...
		public ShowFeatureButton():void {
			this.m_featureButton.visible = Util.ObjectInArray(ControllerGameGlobals.userName, ControllerGameGlobals.ADMIN_USERS);
			this.m_featureButton2.visible = Util.ObjectInArray(ControllerGameGlobals.userName, ControllerGameGlobals.ADMIN_USERS);
		}
