...
import { b2AABB, b2Bound, b2BoundValues, b2Math, b2Pair, b2PairCallback, b2PairManager, b2Proxy, b2Settings, b2Vec2, uint } from "..";
...
//public:
	...
	public CreateProxy(aabb:b2AABB, userData:any):number{
		...
		for (var axis:number = 0; axis < 2; ++axis)
		{
			...
			var lowerIndex:number = 0;
			var upperIndex:number = 0;
