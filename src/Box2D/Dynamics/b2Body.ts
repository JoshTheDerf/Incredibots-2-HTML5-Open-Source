...
import { b2ShapeDef, b2Shape, b2MassData, b2Mat22, b2Vec2, b2XForm, b2Math, b2JointEdge, b2World, b2BodyDef, b2Sweep, b2ContactEdge } from "..";
...
export class b2Body
{
	...
	public SetMass(massData:b2MassData) : void{
		...
		var oldType:number = this.m_type;
	...
	public SynchronizeTransform() : void{
		var angle:number = this.m_sweep.a, c:number = Math.cos(angle), s:number = Math.sin(angle), tMat:b2Mat22 = this.m_xf.R, col1:b2Vec2 = tMat.col1, col2:b2Vec2 = tMat.col2, tVec:b2Vec2 = this.m_sweep.localCenter;
		col1.x = c; col2.x = -s;
		col1.y = s; col2.y = c;
	...
	public m_mass:number, m_invMass:number;
	public m_I:number, m_invI:number;
	...
	//enum
	//{
		public static e_frozenFlag:number			= 0x0002;
		public static e_islandFlag:number			= 0x0004;
		public static e_sleepFlag:number			= 0x0008;
		public static e_allowSleepFlag:number		= 0x0010;
		public static e_bulletFlag:number			= 0x0020;
		public static e_fixedRotationFlag:number	= 0x0040;
	//};
