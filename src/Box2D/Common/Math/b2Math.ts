...
import { b2Vec2, b2Mat22, b2XForm } from "../..";

export class b2Math {

	/// This is used to ensure that a floating point number is
	...
	public static b2MulTMV(A:b2Mat22, v:b2Vec2):b2Vec2
	{
		...
		var u:b2Vec2 = new b2Vec2(b2Math.b2Dot(v, A.col1), b2Math.b2Dot(v, A.col2));
		return u;
	}

	public static b2MulX(T:b2XForm, v:b2Vec2) : b2Vec2
	{
		var a:b2Vec2 = b2Math.b2MulMV(T.R, v);
		a.x += T.position.x;
		a.y += T.position.y;
	...
	{
		var C:b2Mat22 = new b2Mat22(0, b2Math.AddVV(A.col1, B.col1), b2Math.AddVV(A.col2, B.col2));
		return C;
	}
	...
	{
		var C:b2Mat22 = new b2Mat22(0, b2Math.b2MulMV(A, B.col1), b2Math.b2MulMV(A, B.col2));
		return C;
	}
	...
	{
		var c1:b2Vec2 = new b2Vec2(b2Math.b2Dot(A.col1, B.col1), b2Math.b2Dot(A.col2, B.col1));
		var c2:b2Vec2 = new b2Vec2(b2Math.b2Dot(A.col1, B.col2), b2Math.b2Dot(A.col2, B.col2));
	...
	{
		var b:b2Vec2 = new b2Vec2(b2Math.b2Abs(a.x), b2Math.b2Abs(a.y));
		return b;
	}

	public static b2AbsM(A:b2Mat22):b2Mat22
	{
		var B:b2Mat22 = new b2Mat22(0, b2Math.b2AbsV(A.col1), b2Math.b2AbsV(A.col2));
		return B;
	}
	...
	{
		var c:b2Vec2 = new b2Vec2(b2Math.b2Min(a.x, b.x), b2Math.b2Min(a.y, b.y));
		return c;
	}
	...
	{
		var c:b2Vec2 = new b2Vec2(b2Math.b2Max(a.x, b.x), b2Math.b2Max(a.y, b.y));
		return c;
	}
	...
	public static b2Swap(a:Array<any>, b:Array<any>) : void
	{
		var tmp:any = a[0];
		a[0] = b[0];
		b[0] = tmp;
	...
	public static b2Vec2_zero:b2Vec2 = new b2Vec2(0.0, 0.0);
	public static b2Mat22_identity:b2Mat22 = new b2Mat22(0, new b2Vec2(1.0, 0.0), new b2Vec2(0.0, 1.0));
	public static b2XForm_identity:b2XForm = new b2XForm(b2Math.b2Vec2_zero, b2Math.b2Mat22_identity);
}
