...
/// Vendored from the `lzma` npm package (© 2015 Nathan Rugg, MIT) and given a
/// proper ES module export so modern bundlers can resolve `LZMA` statically.
/// The original relied on `this.LZMA = ...` (CommonJS `module.exports`), which
/// rolldown/Vite misinterprets as an ES module.
export { LZMA, LZMA as LZMA_WORKER };
