...
export class Database
{
	...
	public static const SHARED:number = 1;
	public static const ALLTIME:number = 2;
	public static const DAILY:number = 3;
	public static const PERSONAL:number = 4;

	public static const SORT_BY_SCORE:number = -1;
	public static const SORT_BY_VIEW_COUNT:number = 0;
	public static const SORT_BY_CREATION_TIME:number = 1;
	public static const SORT_BY_EDIT_TIME:number = 2;
	public static const SORT_ALPHABETICALLY:number = 3;
	public static const SORT_BY_RATING:number = 4;

	public static const SORT_PERIOD_FEATURED:number = -1;
	public static const SORT_PERIOD_ALLTIME:number = 0;
	public static const SORT_PERIOD_TODAY:number = 1;
	public static const SORT_PERIOD_7DAYS:number = 2;
	public static const SORT_PERIOD_30DAYS:number = 3;
	public static const SORT_PERIOD_PROP:number = 4;

	public static const NUM_ACTIONS:number = 28;
	public static const ACTION_SAVE_ROBOT:number = 0;
	public static const ACTION_GET_ROBOT_DATA:number = 1;
	public static const ACTION_LOAD_ROBOT:number = 2;
	public static const ACTION_DELETE_ROBOT:number = 3;
	public static const ACTION_SAVE_REPLAY:number = 4;
	public static const ACTION_GET_REPLAY_DATA:number = 5;
	public static const ACTION_LOAD_REPLAY:number = 6;
	public static const ACTION_DELETE_REPLAY:number = 7;
	public static const ACTION_GET_SCORE_DATA:number = 8;
	public static const ACTION_ADD_USER:number = 9;
	public static const ACTION_LOGIN:number = 10;
	public static const ACTION_COMMENT_ROBOT:number = 11;
	public static const ACTION_COMMENT_REPLAY:number = 12;
	public static const ACTION_REPORT_ROBOT:number = 13;
	public static const ACTION_REPORT_REPLAY:number = 14;
	public static const ACTION_RATE_ROBOT:number = 15;
	public static const ACTION_RATE_REPLAY:number = 16;
	public static const ACTION_FEATURE_ROBOT:number = 17;
	public static const ACTION_FEATURE_REPLAY:number = 18;
	public static const ACTION_LOGIN_GOLD:number = 19;
	public static const ACTION_SAVE_CHALLENGE:number = 20;
	public static const ACTION_GET_CHALLENGE_DATA:number = 21;
	public static const ACTION_LOAD_CHALLENGE:number = 22;
	public static const ACTION_DELETE_CHALLENGE:number = 23;
	public static const ACTION_COMMENT_CHALLENGE:number = 24;
	public static const ACTION_REPORT_CHALLENGE:number = 25;
	public static const ACTION_RATE_CHALLENGE:number = 26;
	public static const ACTION_FEATURE_CHALLENGE:number = 27;

	private static const WRONG_VERSION_CODE:number = 17;

	public static const VERSION_STRING_FOR_REPLAYS:string = "0.03";
	private static const BASE_URL:string = "http://localhost:8888/incredibots2/database/ggscores.php?version=" + Database.VERSION_STRING_FOR_REPLAYS + "&";

	private static const UNKNOWN_MESSAGE:string = "UNKNOWN";
	private static const IO_MESSAGE:string = "An I/O error has occurred.";
	private static const SECURITY_MESSAGE:string = "A security error has occurred.";
	private static const NO_DATA_MESSAGE:string = "An unknown error has occurred.";
	private static const EXCEPTION_MESSAGE:string = "An error has occurred.";
	private static const ERROR_MESSAGES:Array<any> = ["Failed to connect to the server.",
	...
	private static const TIMEOUT_SECONDS:number = 20;
	...
	public static AddUser(username:string, password:string, completionFunction:Function):void {
		...
		var request:URLRequest = new URLRequest(Database.Encrypt(Database.BASE_URL + "op=addUser&user=" + escape(username) + "&password=" + MD5.encrypt(password)));
	...
	public static Login(username:string, password:string, completionFunction:Function):void {
		if (Database.waitingForResponse) return;
		Database.loader = new URLLoader();
		var request:URLRequest = new URLRequest(Database.Encrypt(Database.BASE_URL + "op=login&user=" + escape(username) + "&password=" + MD5.encrypt(password)));
		request.method = URLRequestMethod.GET;
		Database.loader.dataFormat = URLLoaderDataFormat.TEXT;
		Database.loader.addEventListener(Event.COMPLETE, completionFunction);
		Database.loader.addEventListener(SecurityErrorEvent.SECURITY_ERROR, Database.ErrorHandler);
	...
	public static LoginGold(username:string, password:string, completionFunction:Function):void {
		if (Database.waitingForResponse) return;
		Database.loader = new URLLoader();
		var request:URLRequest = new URLRequest(Database.Encrypt(Database.BASE_URL + "op=goldLogin&user=" + escape(username) + "&password=" + MD5.encrypt(password)));
		request.method = URLRequestMethod.GET;
		Database.loader.dataFormat = URLLoaderDataFormat.TEXT;
		Database.loader.addEventListener(Event.COMPLETE, completionFunction);
		Database.loader.addEventListener(SecurityErrorEvent.SECURITY_ERROR, Database.ErrorHandler);
	...
	public static SaveRobot(user:string, password:string, robot:Robot, name:string, desc:string, shared:number, allowEdits:number, prop:number, challenge:string, completionFunction:Function):void {
		if (Database.waitingForResponse) return;
		var partData:ByteArray = Database.PutRobotIntoByteArray(robot);
		partData.compress();
		Database.loader = new URLLoader();
		var request:URLRequest = new URLRequest(Database.Encrypt(Database.BASE_URL + "op=uploadRobot&user=" + escape(user) + "&password=" + password + "&shared=" + shared + "&allowEdit=" + allowEdits + "&prop=" + prop + (name == null ? "" : "&name=" + escape(name)) + (desc == null ? "" : "&desc=" + escape(desc)) + (challenge == "" ? "" : "&challenge=" + challenge)));
	...
	public static ExportRobot(robot:Robot, name:string, desc:string, shared:number, allowEdits:number, prop:number, completionFunction:Function):void {
		var partData:ByteArray = Database.PutRobotIntoByteArray(robot);
	...
	public static ExportReplay(replay:Replay, name:string, desc:string, robotID:string, robot:Robot, score:number, challenge:string, shared:number, completionFunction:Function):void {
	...
	public static ExportChallenge(challenge:Challenge, name:string, desc:string, shared:number, allowEdits:number, completionFunction:Function):void {
	...
	public static GetRobotData(user:string, password:string, shared:boolean, sortType:number, sortPeriod:number, page:number, search:string, completionFunction:Function):void {
		if (Database.waitingForResponse) return;
		...
		Database.loader = new URLLoader();
		var request:URLRequest = new URLRequest(Database.Encrypt(Database.BASE_URL + "op=getRobots&user=" + (shared ? "_Public" : escape(user)) + "&password=" + password + "&sortType=" + sortType + "&sortPeriod=" + sortPeriod + "&page=" + page + "&search=" + escape(search)));
		request.method = URLRequestMethod.GET;
		Database.loader.dataFormat = URLLoaderDataFormat.TEXT;
		Database.loader.addEventListener(Event.COMPLETE, completionFunction);
		Database.loader.addEventListener(SecurityErrorEvent.SECURITY_ERROR, Database.ErrorHandler);
	...
	public static LoadRobot(user:string, password:string, number:number, completionFunction:Function):void {
		if (Database.waitingForResponse) return;
		Database.loader = new URLLoader();
		var request:URLRequest = new URLRequest(Database.Encrypt(Database.BASE_URL + "op=downloadRobot&user=" + escape(user) + "&password=" + password + "&id=" + Database.robotList[number].id));
		request.method = URLRequestMethod.GET;
	...
	public static LoadRobotByID(robotID:string, completionFunction:Function):void {
		if (Database.waitingForResponse) return;
		Database.loader = new URLLoader();
		var request:URLRequest = new URLRequest(Database.Encrypt(Database.BASE_URL + "op=downloadRobot&user=_Public&password=blah&id=" + robotID));
		request.method = URLRequestMethod.GET;
		Database.loader.dataFormat = URLLoaderDataFormat.BINARY;
	...
	public static DeleteRobot(user:string, password:string, number:number, completionFunction:Function):void {
		if (Database.waitingForResponse) return;
		Database.loader = new URLLoader();
		var request:URLRequest = new URLRequest(Database.Encrypt(Database.BASE_URL + "op=deleteRobot&user=" + escape(user) + "&password=" + password + "&id=" + Database.robotList[number].id));
		request.method = URLRequestMethod.GET;
		Database.loader.dataFormat = URLLoaderDataFormat.TEXT;
		Database.loader.addEventListener(Event.COMPLETE, completionFunction);
		Database.loader.addEventListener(SecurityErrorEvent.SECURITY_ERROR, Database.ErrorHandler);
	...
	public static SaveReplay(user:string, password:string, replay:Replay, name:string, desc:string, robotID:string, robot:Robot, score:number, challenge:string, shared:number, completionFunction:Function):void {
		if (Database.waitingForResponse) return;
		...
		Database.loader = new URLLoader();
		var request:URLRequest = new URLRequest(Database.Encrypt(Database.BASE_URL + "op=uploadReplay&user=" + escape(user) + "&password=" + password + "&shared=" + shared + (name == null ? "" : "&name=" + escape(name)) + (desc == null ? "" : "&desc=" + escape(desc)) + "&robot=" + robotID + "&replayLength=" + replayAndRobot.length + "&score=" + score + "&challenge=" + challenge));
	...
	public static GetReplayData(user:string, password:string, shared:boolean, sortType:number, sortPeriod:number, page:number, search:string, completionFunction:Function):void {
		if (Database.waitingForResponse) return;
		...
		Database.curSearch = search;
		Database.loader = new URLLoader();
		var request:URLRequest = new URLRequest(Database.Encrypt(Database.BASE_URL + "op=getReplays&user=" + (shared ? "_Public" : escape(user)) + "&password=" + password + "&sortType=" + sortType + "&sortPeriod=" + sortPeriod + "&page=" + page + "&search=" + escape(search)));
		request.method = URLRequestMethod.GET;
		Database.loader.dataFormat = URLLoaderDataFormat.TEXT;
		Database.loader.addEventListener(Event.COMPLETE, completionFunction);
		Database.loader.addEventListener(SecurityErrorEvent.SECURITY_ERROR, Database.ErrorHandler);
	...
	public static LoadReplay(user:string, password:string, number:number, completionFunction:Function):void {
		if (Database.waitingForResponse) return;
		Database.loader = new URLLoader();
		var request:URLRequest = new URLRequest(Database.Encrypt(Database.BASE_URL + "op=downloadReplay&user=" + escape(user) + "&password=" + password + "&id=" + Database.replayList[number].id + "&robot=" + Database.replayList[number].robotID));
		request.method = URLRequestMethod.GET;
		Database.loader.dataFormat = URLLoaderDataFormat.BINARY;
		Database.loader.addEventListener("complete", completionFunction);
		Database.loader.addEventListener(SecurityErrorEvent.SECURITY_ERROR, Database.ErrorHandler);
	...
	public static LoadReplayByID(replayID:string, completionFunction:Function):void {
		if (Database.waitingForResponse) return;
		Database.loader = new URLLoader();
		var request:URLRequest = new URLRequest(Database.Encrypt(Database.BASE_URL + "op=downloadReplay&user=_Public&password=blah&id=" + replayID + "&robot=-1"));
		request.method = URLRequestMethod.GET;
		Database.loader.dataFormat = URLLoaderDataFormat.BINARY;
		Database.loader.addEventListener("complete", completionFunction);
		Database.loader.addEventListener(SecurityErrorEvent.SECURITY_ERROR, Database.ErrorHandler);
	...
	public static LoadReplayFromScore(user:string, password:string, number:number, completionFunction:Function):void {
		if (Database.waitingForResponse) return;
		Database.loader = new URLLoader();
		var request:URLRequest = new URLRequest(Database.Encrypt(Database.BASE_URL + "op=downloadReplay&user=" + escape(user) + "&password=" + password + "&id=" + Database.scoreList[number].replayID + "&robot=" + Database.scoreList[number].robotID));
		request.method = URLRequestMethod.GET;
		Database.loader.dataFormat = URLLoaderDataFormat.BINARY;
		Database.loader.addEventListener("complete", completionFunction);
		Database.loader.addEventListener(SecurityErrorEvent.SECURITY_ERROR, Database.ErrorHandler);
	...
	public static DeleteReplay(user:string, password:string, number:number, completionFunction:Function):void {
		if (Database.waitingForResponse) return;
		Database.loader = new URLLoader();
		var request:URLRequest = new URLRequest(Database.Encrypt(Database.BASE_URL + "op=deleteReplay&user=" + escape(user) + "&password=" + password + "&id=" + Database.replayList[number].id));
		request.method = URLRequestMethod.GET;
		Database.loader.dataFormat = URLLoaderDataFormat.TEXT;
		Database.loader.addEventListener("complete", completionFunction);
		Database.loader.addEventListener(SecurityErrorEvent.SECURITY_ERROR, Database.ErrorHandler);
	...
	public static GetScoreData(user:string, password:string, challenge:string, daily:boolean, personal:boolean, sortType:number, page:number, search:string, completionFunction:Function):void {
		if (Database.waitingForResponse) return;
		...
		Database.curSearch = search;
		Database.loader = new URLLoader();
		var request:URLRequest = new URLRequest(Database.Encrypt(Database.BASE_URL + "op=getScores&user=" + escape(user) + "&password=" + password + "&challenge=" + challenge + "&daily=" + (daily ? 1 : 0) + "&personal=" + (personal ? 1 : 0) + "&sortType=" + sortType + "&page=" + page + "&search=" + escape(search)));
		request.method = URLRequestMethod.GET;
		Database.loader.dataFormat = URLLoaderDataFormat.TEXT;
		Database.loader.addEventListener(Event.COMPLETE, completionFunction);
		Database.loader.addEventListener(SecurityErrorEvent.SECURITY_ERROR, Database.ErrorHandler);
	...
	public static SaveChallenge(user:string, password:string, challenge:Challenge, name:string, desc:string, allParts:Array<any>, shared:number, allowEdits:number, completionFunction:Function):void {
		if (Database.waitingForResponse) return;
		...
		Database.loader = new URLLoader();
		var request:URLRequest = new URLRequest(Database.Encrypt(Database.BASE_URL + "op=uploadChallenge&user=" + escape(user) + "&password=" + password + "&shared=" + shared + "&allowEdit=" + allowEdits + (name == null ? "" : "&name=" + escape(name)) + (desc == null ? "" : "&desc=" + escape(desc))));
	...
	public static GetChallengeData(user:string, password:string, shared:boolean, sortType:number, sortPeriod:number, page:number, search:string, completionFunction:Function):void {
		if (Database.waitingForResponse) return;
		...
		Database.curSearch = search;
		Database.loader = new URLLoader();
		var request:URLRequest = new URLRequest(Database.Encrypt(Database.BASE_URL + "op=getChallenges&user=" + (shared ? "_Public" : escape(user)) + "&password=" + password + "&sortType=" + sortType + "&sortPeriod=" + sortPeriod + "&page=" + page + "&search=" + escape(search)));
		request.method = URLRequestMethod.GET;
		Database.loader.dataFormat = URLLoaderDataFormat.TEXT;
		Database.loader.addEventListener(Event.COMPLETE, completionFunction);
		Database.loader.addEventListener(SecurityErrorEvent.SECURITY_ERROR, Database.ErrorHandler);
	...
	public static LoadChallenge(user:string, password:string, number:number, completionFunction:Function):void {
		if (Database.waitingForResponse) return;
		Database.loader = new URLLoader();
		var request:URLRequest = new URLRequest(Database.Encrypt(Database.BASE_URL + "op=downloadChallenge&user=" + escape(user) + "&password=" + password + "&id=" + Database.challengeList[number].id));
		request.method = URLRequestMethod.GET;
		Database.loader.dataFormat = URLLoaderDataFormat.BINARY;
		Database.loader.addEventListener("complete", completionFunction);
		Database.loader.addEventListener(SecurityErrorEvent.SECURITY_ERROR, Database.ErrorHandler);
	...
	public static LoadChallengeByID(challengeID:string, completionFunction:Function):void {
		if (Database.waitingForResponse) return;
		Database.loader = new URLLoader();
		var request:URLRequest = new URLRequest(Database.Encrypt(Database.BASE_URL + "op=downloadChallenge&user=_Public&password=blah&id=" + challengeID));
		request.method = URLRequestMethod.GET;
		Database.loader.dataFormat = URLLoaderDataFormat.BINARY;
		Database.loader.addEventListener("complete", completionFunction);
		Database.loader.addEventListener(SecurityErrorEvent.SECURITY_ERROR, Database.ErrorHandler);
	...
	public static DeleteChallenge(user:string, password:string, number:number, completionFunction:Function):void {
		if (Database.waitingForResponse) return;
		Database.loader = new URLLoader();
		var request:URLRequest = new URLRequest(Database.Encrypt(Database.BASE_URL + "op=deleteChallenge&user=" + escape(user) + "&password=" + password + "&id=" + Database.challengeList[number].id));
		request.method = URLRequestMethod.GET;
		Database.loader.dataFormat = URLLoaderDataFormat.TEXT;
		Database.loader.addEventListener("complete", completionFunction);
		Database.loader.addEventListener(SecurityErrorEvent.SECURITY_ERROR, Database.ErrorHandler);
	...
	public static CommentOnChallenge(challengeID:string, completionFunction:Function):void {
		if (Database.waitingForResponse) return;
		Database.loader = new URLLoader();
		var request:URLRequest = new URLRequest(Database.Encrypt(Database.BASE_URL + "op=commentChallenge&id=" + challengeID));
		request.method = URLRequestMethod.GET;
		Database.loader.dataFormat = URLLoaderDataFormat.TEXT;
		Database.loader.addEventListener(Event.COMPLETE, completionFunction);
		Database.loader.addEventListener(SecurityErrorEvent.SECURITY_ERROR, Database.ErrorHandler);
	...
	public static ReportRobot(robotID:string, user:string, msg:string, completionFunction:Function):void {
		if (Database.waitingForResponse) return;
		Database.loader = new URLLoader();
		var request:URLRequest = new URLRequest(Database.Encrypt(Database.BASE_URL + "op=reportRobot&id=" + robotID + "&user=" + escape(user) + "&desc=" + escape(msg)));
		request.method = URLRequestMethod.GET;
		Database.loader.dataFormat = URLLoaderDataFormat.TEXT;
		Database.loader.addEventListener(Event.COMPLETE, completionFunction);
		Database.loader.addEventListener(SecurityErrorEvent.SECURITY_ERROR, Database.ErrorHandler);
	...
	public static ReportReplay(replayID:string, user:string, msg:string, completionFunction:Function):void {
		if (Database.waitingForResponse) return;
		Database.loader = new URLLoader();
		var request:URLRequest = new URLRequest(Database.Encrypt(Database.BASE_URL + "op=reportReplay&id=" + replayID + "&user=" + escape(user) + "&desc=" + escape(msg)));
		request.method = URLRequestMethod.GET;
		Database.loader.dataFormat = URLLoaderDataFormat.TEXT;
		Database.loader.addEventListener(Event.COMPLETE, completionFunction);
		Database.loader.addEventListener(SecurityErrorEvent.SECURITY_ERROR, Database.ErrorHandler);
	...
	public static ReportChallenge(challengeID:string, user:string, msg:string, completionFunction:Function):void {
		if (Database.waitingForResponse) return;
		Database.loader = new URLLoader();
		var request:URLRequest = new URLRequest(Database.Encrypt(Database.BASE_URL + "op=reportChallenge&id=" + challengeID + "&user=" + escape(user) + "&desc=" + escape(msg)));
		request.method = URLRequestMethod.GET;
		Database.loader.dataFormat = URLLoaderDataFormat.TEXT;
		Database.loader.addEventListener(Event.COMPLETE, completionFunction);
		Database.loader.addEventListener(SecurityErrorEvent.SECURITY_ERROR, Database.ErrorHandler);
	...
	public static RateRobot(robotID:string, rating:number, completionFunction:Function):void {
		if (Database.waitingForResponse) return;
		Database.loader = new URLLoader();
		var request:URLRequest = new URLRequest(Database.Encrypt(Database.BASE_URL + "op=rateRobot&id=" + robotID + "&rating=" + rating));
		request.method = URLRequestMethod.GET;
		Database.loader.dataFormat = URLLoaderDataFormat.TEXT;
		Database.loader.addEventListener(Event.COMPLETE, completionFunction);
		Database.loader.addEventListener(SecurityErrorEvent.SECURITY_ERROR, Database.ErrorHandler);
	...
	public static RateReplay(replayID:string, rating:number, completionFunction:Function):void {
		if (Database.waitingForResponse) return;
		Database.loader = new URLLoader();
		var request:URLRequest = new URLRequest(Database.Encrypt(Database.BASE_URL + "op=rateReplay&id=" + replayID + "&rating=" + rating));
		request.method = URLRequestMethod.GET;
		Database.loader.dataFormat = URLLoaderDataFormat.TEXT;
		Database.loader.addEventListener(Event.COMPLETE, completionFunction);
		Database.loader.addEventListener(SecurityErrorEvent.SECURITY_ERROR, Database.ErrorHandler);
	...
	public static RateChallenge(challengeID:string, rating:number, completionFunction:Function):void {
		if (Database.waitingForResponse) return;
		Database.loader = new URLLoader();
		var request:URLRequest = new URLRequest(Database.Encrypt(Database.BASE_URL + "op=rateChallenge&id=" + challengeID + "&rating=" + rating));
		request.method = URLRequestMethod.GET;
		Database.loader.dataFormat = URLLoaderDataFormat.TEXT;
		Database.loader.addEventListener(Event.COMPLETE, completionFunction);
		Database.loader.addEventListener(SecurityErrorEvent.SECURITY_ERROR, Database.ErrorHandler);
	...
	public static FeatureRobot(robotID:string, feature:boolean, completionFunction:Function):void {
		if (Database.waitingForResponse) return;
		Database.loader = new URLLoader();
		var request:URLRequest = new URLRequest(Database.Encrypt(Database.BASE_URL + "op=featureRobot&id=" + robotID + "&featured=" + (feature ? 1 : 0)));
		request.method = URLRequestMethod.GET;
		Database.loader.dataFormat = URLLoaderDataFormat.TEXT;
		Database.loader.addEventListener(Event.COMPLETE, completionFunction);
		Database.loader.addEventListener(SecurityErrorEvent.SECURITY_ERROR, Database.ErrorHandler);
	...
	public static FeatureReplay(replayID:string, feature:boolean, completionFunction:Function):void {
		if (Database.waitingForResponse) return;
		Database.loader = new URLLoader();
		var request:URLRequest = new URLRequest(Database.Encrypt(Database.BASE_URL + "op=featureReplay&id=" + replayID + "&featured=" + (feature ? 1 : 0)));
		request.method = URLRequestMethod.GET;
		Database.loader.dataFormat = URLLoaderDataFormat.TEXT;
		Database.loader.addEventListener(Event.COMPLETE, completionFunction);
		Database.loader.addEventListener(SecurityErrorEvent.SECURITY_ERROR, Database.ErrorHandler);
	...
	public static FeatureChallenge(challengeID:string, feature:boolean, completionFunction:Function):void {
		if (Database.waitingForResponse) return;
		Database.loader = new URLLoader();
		var request:URLRequest = new URLRequest(Database.Encrypt(Database.BASE_URL + "op=featureChallenge&id=" + challengeID + "&featured=" + (feature ? 1 : 0)));
		request.method = URLRequestMethod.GET;
		Database.loader.dataFormat = URLLoaderDataFormat.TEXT;
		Database.loader.addEventListener(Event.COMPLETE, completionFunction);
		Database.loader.addEventListener(SecurityErrorEvent.SECURITY_ERROR, Database.ErrorHandler);
	...
	public static FinishLoadingRobot(e:Event):Robot {
		...
		if (responseData.length == 6 || responseData.length == 7) {
			...
			if (errorStr == "ERROR") {
				Database.ErrorHandler(new Event(""), Database.ERROR_MESSAGES[parseInt(responseData.readUTFBytes(responseData.bytesAvailable))]);
				return null;
			} else {
	...
	public static FinishDeletingChallenge(e:Event):boolean {
		...
		if (response.search("ERROR") != -1) {
			...
			try {
				Database.challengeList = Util.RemoveFromArray(Database.challengeList[Database.deleteNumber], Database.challengeList);
				Database.nonfatalErrorOccurred = false;
				return true;
			} catch (e:Error) {
				Database.ErrorHandler(new Event(""), Database.EXCEPTION_MESSAGE);
	...
	private static PutChallengeIntoByteArray(challenge:Challenge):ByteArray {
		...
		for (var i:number = challenge.winConditions.length - 1; i >= 0; i--) {
			...
			if ((challenge.winConditions[i].subject == 0 && challenge.winConditions[i].shape1Index == -1) || (challenge.winConditions[i].object > 4 && challenge.winConditions[i].shape2Index == -1)) {
		...
		for (i = challenge.lossConditions.length - 1; i >= 0; i--) {
			...
			if ((challenge.lossConditions[i].subject == 0 && challenge.lossConditions[i].shape1Index == -1) || (challenge.lossConditions[i].object > 4 && challenge.lossConditions[i].shape2Index == -1)) {
	...
	public static ExtractChallengeFromByteArray(data:ByteArray):Challenge {
		...
		var c:Challenge = new Challenge(new SandboxSettings(settings.gravity, settings.size, settings.terrainType, settings.terrainTheme, settings.background, settings.backgroundR, settings.backgroundG, settings.backgroundB));
		c.allParts = partData;
		...
		for (i = 0; i < conditions.length; i++) {
			var con:LossCondition = new LossCondition(conditions[i].name, conditions[i].subject, conditions[i].object, conditions[i].immediate);
		...
		if (data.position != data.length) {
			...
			c.cannonsAllowed = (c.rectanglesAllowed && c.slidingJointsAllowed && c.rotatingJointsAllowed && c.slidingJointsAllowed && c.thrustersAllowed);
		}
		return c;
	}
	...
	private static ExtractPartsFromByteArray(b:ByteArray):Array<any> {
		...
		for (var i:number = 0; i < objectData.length; i++) {
			if (objectData[i].type == "Circle" || objectData[i].type == "Rectangle" || objectData[i].type == "Triangle" || objectData[i].type == "Cannon") {
				var shape:ShapePart;
				if (objectData[i].type == "Circle") {
					...
					shape = new Triangle(objectData[i].x1, objectData[i].y1, objectData[i].x2, objectData[i].y2, objectData[i].x3, objectData[i].y3);
				...
				var text:TextPart = new TextPart((Main.m_curController as ControllerGame), objectData[i].x, objectData[i].y, objectData[i].w, objectData[i].h, objectData[i].text, objectData[i].inFront);
				...
				if (objectData[i].shapeIndex >= 0) {
					var t:Thrusters = new Thrusters(partData[objectData[i].shapeIndex], objectData[i].centerX, objectData[i].centerY);
			...
			} else if (objectData[i].type == "FixedJoint" || objectData[i].type == "RevoluteJoint" || objectData[i].type == "PrismaticJoint") {
				if (objectData[i].part1Index >= 0 && objectData[i].part2Index >= 0) {
					var joint:JointPart;
					if (objectData[i].type == "FixedJoint") {
						joint = new FixedJoint(partData[objectData[i].part1Index], partData[objectData[i].part2Index], objectData[i].anchorX, objectData[i].anchorY);
					} else if (objectData[i].type == "RevoluteJoint") {
						joint = new RevoluteJoint(partData[objectData[i].part1Index], partData[objectData[i].part2Index], objectData[i].anchorX, objectData[i].anchorY);
						...
						joint = new PrismaticJoint(partData[objectData[i].part1Index], partData[objectData[i].part2Index], 0, 0, 1, 1);
	...
	public static ExtractRobotFromByteArray(data:ByteArray):Robot {
		...
		if (data.position == data.length) {
			...
			return new Robot(partData, new SandboxSettings(settings.gravity, settings.size, settings.terrainType, settings.terrainTheme, settings.background, settings.backgroundR, settings.backgroundG, settings.backgroundB), cameraX, cameraY, zoomLevel);
		}
	}
	...
	private static PutReplayIntoByteArray(replay:Replay):ByteArray {
		...
		for (i = 0; i < replay.syncPoints.length; i++) {
			...
			for (var j:number = 0; j < replay.syncPoints[i].positions.length; j++) {
				if (i == 0 || i == replay.syncPoints.length - 1 || replay.syncPoints[i].positions[j].x != replay.syncPoints[i - 1].positions[j].x || replay.syncPoints[i].positions[j].y != replay.syncPoints[i - 1].positions[j].y || replay.syncPoints[i].angles[j] != replay.syncPoints[i - 1].angles[j]) {
					Database.WriteFloat(b, replay.syncPoints[i].positions[j].x);
					Database.WriteFloat(b, replay.syncPoints[i].positions[j].y);
					if (replay.syncPoints[i].angles[j] <= -32.7 || replay.syncPoints[i].angles[j] >= 32.8) Database.WriteFloat(b, Database.NormalizeAngle(replay.syncPoints[i].angles[j]) * 10);
	...
	private static ParseTimestamp(timestamp:string):number {
		...
		if (isNaN(num) && timestamp.length == 14) {
			timestamp = timestamp.substr(0, 4) + "/" + timestamp.substr(4, 2) + "/" + timestamp.substr(6, 2) + " " + timestamp.substr(8, 2) + ":" + timestamp.substr(10, 2) + ":" + timestamp.substr(12, 2);
