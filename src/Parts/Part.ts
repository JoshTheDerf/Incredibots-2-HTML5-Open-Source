import { b2World, b2Body } from "../Box2D";
...
export class Part
{
	...
	public ToString():string {
		return "isEnabled=" + this.isEnabled + ", isStatic=" + this.isStatic + ", isEditable=" + this.isEditable + ", isInitted=" + this.isInitted + ", type=" + this.type;
	}
}
