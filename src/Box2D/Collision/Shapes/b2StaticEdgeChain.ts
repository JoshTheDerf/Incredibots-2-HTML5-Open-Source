...
import { b2Settings, b2ShapeDef, b2StaticEdgeChainDef, b2StaticEdgeShape, b2Vec2, b2World } from "../..";
...
export class b2StaticEdgeChain
{
	constructor(def:b2ShapeDef, world: b2World){
		...
		var len:number = this.edges.length;
		for (; i < len; i++) {
			s2 = this.edges[i];
	...
	public edges: Array<any> = new Array();
