...
import { b2Body, b2CircleShape, b2Collision, b2Contact, b2Fixture } from "../..";
...
export class b2CircleContact extends b2Contact
{
	...
	public Evaluate() : void
	{
		...
		b2Collision.CollideCircles(this.m_manifold,this.m_fixtureA!.GetShape() as b2CircleShape,bodyA.m_xf,this.m_fixtureB!.GetShape() as b2CircleShape,bodyB.m_xf);
	}
}
