...
import { b2AABB, b2Body, b2BroadPhase, b2CircleShape, b2ConcaveArcShape, b2ConvexArcShape, b2FilterData, b2MassData, b2Pair, b2PolygonShape, b2Segment, b2ShapeDef, b2Vec2, b2XForm } from "../..";
...
export class b2Shape
{
	...
	public Synchronize(broadPhase:b2BroadPhase, transform1:b2XForm, transform2:b2XForm) : boolean{
		...
		var aabb:b2AABB = b2Shape.s_syncAABB;
