...
import { b2Body, b2Collision, b2Contact, b2Fixture, b2PolygonShape } from "../..";
...
export class b2PolygonContact extends b2Contact
{
	...
	public Evaluate() : void
	{
		...
		b2Collision.CollidePolygons(this.m_manifold,this.m_fixtureA!.GetShape() as b2PolygonShape,bodyA.m_xf,this.m_fixtureB!.GetShape() as b2PolygonShape,bodyB.m_xf);
	}
}
